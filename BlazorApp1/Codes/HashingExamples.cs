...
namespace BlazorApp1.Codes
{
    internal class HashingExamples
    {
        ...
        public static string SHA1Hashing(string textToHash)
        {
            byte[] inputBytes = Encoding.ASCII.GetBytes(textToHash);
        ...
        public static string SHA256Hashing(string textToHash)
        {
            byte[] inputBytes = Encoding.ASCII.GetBytes(textToHash);
        ...
        public static string AESHashing(string textToHash)
        {
            byte[] inputBytes = Encoding.ASCII.GetBytes(textToHash);
